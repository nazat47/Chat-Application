      ...
      <div className="my_message">
        <div className="image_message">
          <div className="my_text">
            <p className="message_text">How are you?</p>
          </div>
        </div>
        ...
        <div className="image_message_time">
          ...
          <div className="message_time">
            <div className="fd_text">
              <p className="message_text">aishduihsdfsdfsdfsdfjiosj isdjfoisdjfoisjdfmisdjfosidjfisdjfsldmcieljsodijfisjoiejfoijesisejofisjifjsodij</p>
            </div>
